        ...
        try {
            if (aid) {
                ...
                try {
                    ...
                    let data;
                    if (ssid)
                        data = await xhr({ url: API.objUrl("https://bangumi.bilibili.com/view/web_api/season", { season_id: ssid }) });
                    else if (epid)
                        data = await xhr({ url: API.objUrl("https://bangumi.bilibili.com/view/web_api/season", { ep_id: epid }) });
                    if (data) {
