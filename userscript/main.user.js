...
// @version      10.1.7-2b43eeb7fff6d473bcc53e4e4b580b5d617bc515
...
customElements.get(\`button-\${"2b43eeb"}\`) || customElements.define(\`button-\${"2b43eeb"}\`, PushButton);
...
customElements.get(\`popupbox-\${"2b43eeb"}\`) || customElements.define(\`popupbox-\${"2b43eeb"}\`, PopupBox);
...
var _Player = class {
  ...
  playbackRate(playbackRate = 1) {
    ...
    this.playbackRateTimer = setTimeout(() => {
      ...
      if (!video)
        return this.BLOD.toast.warning("未找到播放器！请在播放页面使用。");
...
customElements.get(\`preview-image-\${"2b43eeb"}\`) || customElements.define(\`preview-image-\${"2b43eeb"}\`, PreviewImage);
...
customElements.get(\`download-\${"2b43eeb"}\`) || customElements.define(\`download-\${"2b43eeb"}\`, BilioldDownload);
...
customElements.get(\`toast-\${"2b43eeb"}\`) || customElements.define(\`toast-\${"2b43eeb"}\`, Toast, { extends: "div" });
...
customElements.get(\`toast-container-\${"2b43eeb"}\`) || customElements.define(\`toast-container-\${"2b43eeb"}\`, ToastContainer);
...
var AccessKey = class {
  ...
  remove() {
    this.BLOD.status.accessKey.token = void 0;
...
customElements.get(\`desc-\${"2b43eeb"}\`) || customElements.define(\`desc-\${"2b43eeb"}\`, Desc);
...
customElements.get("biliold-entry-2b43eeb") || customElements.define("bilibili-entry-2b43eeb", BilioldEntry);
...
customElements.get(\`item-\${"2b43eeb"}\`) || customElements.define(\`item-\${"2b43eeb"}\`, SettingItem, { extends: "div" });
...
customElements.get(\`item-container-\${"2b43eeb"}\`) || customElements.define(\`item-container-\${"2b43eeb"}\`, ItemContainer, { extends: "div" });
...
customElements.get(\`menuitem-\${"2b43eeb"}\`) || customElements.define(\`menuitem-\${"2b43eeb"}\`, Menuitem, { extends: "div" });
...
customElements.get(\`checkbox-\${"2b43eeb"}\`) || customElements.define(\`checkbox-\${"2b43eeb"}\`, CheckBox);
...
customElements.get(\`checkboxs-\${"2b43eeb"}\`) || customElements.define(\`checkboxs-\${"2b43eeb"}\`, CheckBoxs, { extends: "div" });
...
customElements.get(\`input-\${"2b43eeb"}\`) || customElements.define(\`input-\${"2b43eeb"}\`, InputArea);
...
customElements.get(\`select-\${"2b43eeb"}\`) || customElements.define(\`select-\${"2b43eeb"}\`, SelectMenu);
...
customElements.get(\`slider-\${"2b43eeb"}\`) || customElements.define(\`slider-\${"2b43eeb"}\`, SliderBlock);
...
customElements.get(\`switch-\${"2b43eeb"}\`) || customElements.define(\`switch-\${"2b43eeb"}\`, SwitchButton);
...
var UI = class {
  ...
  initSettingPlayer() {
    ...
    this.menuitem.player.addSetting([
      ...
      this.switch("automate.screenWide", "宽屏模式", "隐藏播放器右侧面板", void 0, (v) => v && (this.BLOD.status.automate.webFullScreen = false), "载入播放器时自动启用宽屏模式。（与网页全屏二选一）"),
      ...
      this.switch("automate.webFullScreen", "网页全屏模式", "载入视频时", void 0, (v) => v && (this.BLOD.status.automate.screenWide = false), "载入播放器时自动网页全屏。（与宽屏模式二选一）"),
...
var Like = class extends HTMLSpanElement {
  ...
  init() {
    ...
    addCss(".ulike {cursor: pointer;}.ulike svg{vertical-align: middle;margin-right: 10px;transform: translateY(-1px);}", \`ulike\${"2b43eeb"}\`);
  }
  /** 更新点赞数 */
  get likes() {
    return this.number;
...
customElements.get(\`like-\${"2b43eeb"}\`) || customElements.define(\`like-\${"2b43eeb"}\`, Like, { extends: "span" });
    ...
    if (this.BLOD.status.episodeData) {
      switchVideo(() => {
        ...
        if (views && danmakus) {
          ...
          apiStat(this.BLOD.aid).then(({ view, danmaku }) => {
      ...
      if (this.status.bilibiliplayer) {
        if (true) {
          ...
          await Promise.all([
            ...
            this.GM.insertCSS("player/video.css", true).then((d) => loadStyle(d))
          ]);
        }
      } else {
