...
// @version      10.1.3-fd1c869cf42826a95fd7c3cd50c27ca7902d6e81
...
customElements.get(\`button-\${"fd1c869"}\`) || customElements.define(\`button-\${"fd1c869"}\`, PushButton);
...
customElements.get(\`popupbox-\${"fd1c869"}\`) || customElements.define(\`popupbox-\${"fd1c869"}\`, PopupBox);
...
customElements.get(\`toast-\${"fd1c869"}\`) || customElements.define(\`toast-\${"fd1c869"}\`, Toast, { extends: "div" });
...
customElements.get(\`toast-container-\${"fd1c869"}\`) || customElements.define(\`toast-container-\${"fd1c869"}\`, ToastContainer);
...
customElements.get("biliold-entry-fd1c869") || customElements.define("bilibili-entry-fd1c869", BilioldEntry);
...
var _Player = class {
  ...
  playbackRate(playbackRate = 1) {
    ...
    this.playbackRateTimer = setTimeout(() => {
      ...
      if (!video)
        throw new Error("未找到播放器！请在播放页面使用。");
...
var Like = class extends HTMLSpanElement {
  ...
  init() {
    ...
    addCss(".ulike {cursor: pointer;}.ulike svg{vertical-align: middle;margin-right: 10px;transform: translateY(-1px);}", \`ulike\${"fd1c869"}\`);
  }
  get likes() {
    return this.number;
  }
...
customElements.get(\`like-\${"fd1c869"}\`) || customElements.define(\`like-\${"fd1c869"}\`, Like, { extends: "span" });
...
customElements.get(\`desc-\${"fd1c869"}\`) || customElements.define(\`desc-\${"fd1c869"}\`, Desc);
...
customElements.get(\`item-\${"fd1c869"}\`) || customElements.define(\`item-\${"fd1c869"}\`, SettingItem, { extends: "div" });
...
customElements.get(\`item-container-\${"fd1c869"}\`) || customElements.define(\`item-container-\${"fd1c869"}\`, ItemContainer, { extends: "div" });
...
customElements.get(\`menuitem-\${"fd1c869"}\`) || customElements.define(\`menuitem-\${"fd1c869"}\`, Menuitem, { extends: "div" });
...
customElements.get(\`checkbox-\${"fd1c869"}\`) || customElements.define(\`checkbox-\${"fd1c869"}\`, CheckBox);
...
customElements.get(\`checkboxs-\${"fd1c869"}\`) || customElements.define(\`checkboxs-\${"fd1c869"}\`, CheckBoxs, { extends: "div" });
...
customElements.get(\`input-\${"fd1c869"}\`) || customElements.define(\`input-\${"fd1c869"}\`, InputArea);
...
customElements.get(\`select-\${"fd1c869"}\`) || customElements.define(\`select-\${"fd1c869"}\`, SelectMenu);
...
customElements.get(\`slider-\${"fd1c869"}\`) || customElements.define(\`slider-\${"fd1c869"}\`, SliderBlock);
...
customElements.get(\`switch-\${"fd1c869"}\`) || customElements.define(\`switch-\${"fd1c869"}\`, SwitchButton);
...
var UI = class {
  ...
  initSettingPlayer() {
    this.menuitem.player.addSetting([
      ...
      }, "播放速率调整拓展", void 0, "调节当前HTML5播放器速率，拥有比播放器自带的更宽的调整范围。注意：初始调整前的值不代表当前实际播放速率，这不影响调节。"),
...
customElements.get(\`download-\${"fd1c869"}\`) || customElements.define(\`download-\${"fd1c869"}\`, BilioldDownload);
