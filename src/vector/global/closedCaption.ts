...
(function () {
    class ClosedCaption {
        ...
        initUI() {
            ...
            this.fontposition();
            this.fontopacrity();
            API.addCss(GM.getResourceText("closedCaption.css"), "caption");
            this.changeResize();
            this.changePosition();
        }
        /**
        ...
        changeStyle() {
            ...
            API.GM.setValue("subtitle", this.setting);
        }
        /**
         * 切换字幕大小
         */
        ...
        language() {
            ...
            this.captions.forEach((d: any) => {
                ...
                temp.onclick = () => {
                    ...
                    this.iconSwitch(d);
                    API.GM.setValue("subtitlePrefer", this.subtitlePrefer = d.lan);
                }
            })
        }
        /**
        ...
        async getCaption(data: any) {
            ...
            } catch (e) { API.debug.trace(e, "closedCaption.js") }
        }
        /**
         * 设置CC字幕
        ...
        async setCaption(caption?: any) {
            ...
            if (caption && caption.subtitle_url) {
                ...
                API.debug.msg(3, "载入字幕", this.captions[0].lan_doc);
            } else API.debug.msg(3, "关闭字幕");
        }
    }
