...
import sliderBlcok from "./sliderBlcok.html";
...
export class SliderBlock extends HTMLElement {
    ...
    constructor(obj: Partial<Value> = {}) {
        ...
        let initing = true;
        // 节点骨架
        root.appendChild(createElements(htmlVnode(sliderBlcok)));
...
customElements.get("slider-block") || customElements.define("slider-block", SliderBlock);