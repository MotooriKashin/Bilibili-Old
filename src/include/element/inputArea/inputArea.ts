interface modules {
    /** 输入样式 */
    readonly "inputArea.html": string;
}
namespace API {
    /** input标签属性 */
    ...
    export class InputArea extends HTMLElement {
        ...
        constructor(obj: Partial<Value> = {}) {
            ...
            // 节点骨架
            root.appendChild(createElements(htmlVnode(getModule("inputArea.html") + getModule("scrollbar.html"))));
            const [input, ul] = [
            ...
            Object.defineProperties(obj, {
                ...
                props: {
                    ...
                    get: () => new Proxy(this.props, new ProxyHandler(flushProps))
                },
                candidate: {
                    set: v => {
