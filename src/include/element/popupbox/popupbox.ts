...
namespace API {
    ...
    export class PopupBox extends HTMLElement {
        ...
        constructor(obj: Partial<Value>) {
            ...
            root.appendChild(createElements(htmlVnode(getModule("popupbox.html").replace('<div class="fork"></div>', `<div class="fork">${getModule("fork.svg")}</div>`))));
