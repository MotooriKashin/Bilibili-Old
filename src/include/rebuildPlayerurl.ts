    ...
    async appPlayurl(app: any) {
        ...
        (<any>this.playurl.dash.video).forEach((d: any, i: any, e: any) => {
            arr.push((async (d) => {
                ...
                if (d.SegmentBase) RebuildPlayerurl.OBJ["sidx" + String(API.cid)][id] = [d.SegmentBase.Initialization, d.SegmentBase.indexRange]
...
declare namespace API {
    export let rebuildPlayerurl: typeof RebuildPlayerurl;
}