...
import type { PixelSnapping } from "./flash/display/PixelSnapping";
import type { Stage } from "./flash/display/Stage";

export class CommentBitmap extends Bitmap {
    constructor({ bitmapData, pixelSnapping, smoothing, x, y, z, alpha, scale, lifeTime = 3, parent, motion, motionGroup }: ICommentBitmap, stage: Stage, delay = 0) {
    ...
    setParent(parent: DisplayObjectContainer) {
        parent.addChild(this);
    }
}

export interface ICommentBitmap {
