...
// 降级内容脚本
loadScript(chrome.runtime.getURL("content/bangumi/userscript.js"));
// 顶栏头像动效
...
window.addEventListener("beforeunload", () => {
    ...
    storage.ss.removeItem("pgc");
    storage.ss.removeItem("ssid");
    storage.ss.removeItem("epid");
    storage.ss.removeItem("th");
    storage.ss.removeItem("bkg_cover");
    storage.ss.removeItem("limit");
    // 注销针对性请求拦截
    chrome.runtime.sendMessage({
