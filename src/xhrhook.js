                            ...
                            if (BLOD.limit) {
                                ...
                                response = BLOD.jsonCheck(await new Promise((resolve, reject) => {
                                    GM_xmlhttpRequest({
                                        method: "POST",
                                        url: url,
                                        data: "",
                                        onload: (xhr) => resolve(xhr.responseText),
                                        onerror: (xhr) => reject(xhr.statusText || url + " net::ERR_CONNECTION_TIMED_OUT"),
                                    });
                                }))
                                debug.log("大会员代理", url, response);
                            }
                        }
