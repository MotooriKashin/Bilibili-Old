...
namespace API {
     ...
     * @returns 注册编号，`once=false`时才有用，可用于取消拦截。
     */
    export function xhrhookasync(url: string | string[], condition?: (args: XMLHttpRequestOpenParams) => boolean, modifyResponse?: (args: XMLHttpRequestOpenParams, type: XMLHttpRequestResponseType) => Promise<XMLHttpRequestResponses>, once = true) {
