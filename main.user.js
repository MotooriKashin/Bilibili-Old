...
(function () {
    ...
    const API = {
        ...
        url: {
            ...
            ranking: "https://api.bilibili.com/x/web-interface/ranking/v2" // rid=0&day=3&type=1&arc_type=0
        },
        // 未识别分区对照表
        sort: {
    ...
    const deliver = {
        ...
        setGlobalStyle: async () => {
            ...
            if (config.reset.oldreply) csss = csss + API.style.comment;
    ...
    const thread = {
        ...
        rank: () => {
            try {
                ...
                if (refer && refer[4] && refer[4] == "all") DOCUMENT = deliver.xhrJsonCheck(xhr.false(deliver.obj2search(API.url.ranking, { rid: refer[5], day: 3 })));
                else DOCUMENT = deliver.xhrJsonCheck(xhr.false(deliver.obj2search(API.url.ranking, { rid: 0, day: 3 })));
                DOCUMENT.data.list.forEach((function (e, i, l) {
                ...
                unsafeWindow.__INITIAL_STATE__ = __INITIAL_STATE__;
                deliver.write(deliver.oldScript(API.pageframe.rank));
            }
