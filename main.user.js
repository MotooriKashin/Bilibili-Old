    ...
    const global = {
        ...
        "resetSction" : () => {
            ...
            document.addEventListener("DOMNodeInserted",(msg) => {
                ...
                if (config.rewrite.av) functionInterface.avdesc();
