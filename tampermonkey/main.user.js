...
// @version      10.3.5-d1dcfd952ed620baa2e8239002c83a06b643e876
...
\`) + "</i>";
  ...
  customElements.get(\`toast-\${"d1dcfd9"}\`) || customElements.define(\`toast-\${"d1dcfd9"}\`, Toast, { extends: "div" });
  ...
  customElements.get(\`toast-container-\${"d1dcfd9"}\`) || customElements.define(\`toast-container-\${"d1dcfd9"}\`, ToastContainer);
  ...
  customElements.get("biliold-entry-d1dcfd9") || customElements.define("bilibili-entry-d1dcfd9", BilioldEntry);
  ...
  customElements.get(\`button-\${"d1dcfd9"}\`) || customElements.define(\`button-\${"d1dcfd9"}\`, PushButton);
  ...
  customElements.get(\`popupbox-\${"d1dcfd9"}\`) || customElements.define(\`popupbox-\${"d1dcfd9"}\`, PopupBox);
...
<div><div style="padding-block: 10px;padding-inline: 15px;">\${msg}</div></div>\`;
  ...
  customElements.get(\`download-\${"d1dcfd9"}\`) || customElements.define(\`download-\${"d1dcfd9"}\`, BilioldDownload);
  ...
  customElements.get(\`preview-image-\${"d1dcfd9"}\`) || customElements.define(\`preview-image-\${"d1dcfd9"}\`, PreviewImage);
  ...
  var Like = class extends HTMLSpanElement {
    ...
    init() {
      ...
      addCss(".ulike {cursor: pointer;}.ulike svg{vertical-align: middle;margin-right: 10px;transform: translateY(-1px);}", \`ulike\${"d1dcfd9"}\`);
    }
    /** 更新点赞数 */
    get likes() {
      return this.number;
  ...
  customElements.get(\`like-\${"d1dcfd9"}\`) || customElements.define(\`like-\${"d1dcfd9"}\`, Like, { extends: "span" });
...
.home-wrap .home-form .home-suggest .hotlist .item {
  ...
  customElements.get(\`desc-\${"d1dcfd9"}\`) || customElements.define(\`desc-\${"d1dcfd9"}\`, Desc);
  ...
  customElements.get(\`item-\${"d1dcfd9"}\`) || customElements.define(\`item-\${"d1dcfd9"}\`, SettingItem, { extends: "div" });
...
<div class="card"></div>\`;
  ...
  customElements.get(\`item-container-\${"d1dcfd9"}\`) || customElements.define(\`item-container-\${"d1dcfd9"}\`, ItemContainer, { extends: "div" });
  ...
  customElements.get(\`menuitem-\${"d1dcfd9"}\`) || customElements.define(\`menuitem-\${"d1dcfd9"}\`, Menuitem, { extends: "div" });
...
\\r
  ...
  customElements.get(\`checkbox-\${"d1dcfd9"}\`) || customElements.define(\`checkbox-\${"d1dcfd9"}\`, CheckBox);
  ...
  customElements.get(\`checkboxs-\${"d1dcfd9"}\`) || customElements.define(\`checkboxs-\${"d1dcfd9"}\`, CheckBoxs, { extends: "div" });
  ...
  customElements.get(\`input-\${"d1dcfd9"}\`) || customElements.define(\`input-\${"d1dcfd9"}\`, InputArea);
  ...
  customElements.get(\`select-\${"d1dcfd9"}\`) || customElements.define(\`select-\${"d1dcfd9"}\`, SelectMenu);
  ...
  customElements.get(\`slider-\${"d1dcfd9"}\`) || customElements.define(\`slider-\${"d1dcfd9"}\`, SliderBlock);
  ...
  customElements.get(\`switch-\${"d1dcfd9"}\`) || customElements.define(\`switch-\${"d1dcfd9"}\`, SwitchButton);
