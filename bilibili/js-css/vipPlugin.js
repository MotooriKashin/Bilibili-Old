window.vipPopup = function(options,callback){
    ...
    var iframe = $('<iframe name="biliVipPlugin" id="biliVipPlugin" src="//vip.bilibili.com/site/vip-payplugin.html'+param+'" allowTransparency="true" frameborder="0" style="position:fixed;top:0;left:0;width:100%;height:100%;background-color:transparent;filter: progid:DXImageTransform.Microsoft.Alpha(opacity=0);z-index:99999999999999999999;"></iframe>').appendTo($('body')).show();
};
