...
- `GM_getResourceURL`/`GM_getResourceURL`：资源跨域，相关`@resource`元数据如下：
   ...
   - [\_\_INITIAL\_STATE\_\_.js](https://github.com/MotooriKashin/Bilibili-Old/tree/master/src/__INITIAL_STATE__.js)：\_\_INITIAL\_STATE\_\_配置模块
...
- 2020-12-27
   + 添加特殊地区番剧下载（需在对应地区），如[ss36377](https://www.bilibili.com/bangumi/play/ss36377)  
     *此类视频只提供DASH格式且帧率、索引等信息丢失无法直接在网页播放器中播放，所以就算获取到了视频流，也只能推送给下载模块*  
     *1080P以上需对应地区账号登录鉴权，与主站账号不互通，就不做进一步的下载支持了*
- 2020-12-25
