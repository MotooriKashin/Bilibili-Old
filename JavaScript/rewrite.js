    ...
    class Rewrite {
        ...
        async space() {
            ...
            BLOD.xhrhook((xhr, args) => {
                ...
                // 恢复相簿链接
                if (args[1].includes("api.bilibili.com/x/dynamic/feed/draw/doc_list")) {
                    xhr.addEventListener('readystatechange', () => {
                        if (xhr.readyState === 4) {
